...
# WL adapted from http://staff.ustc.edu.cn/~zqj/posts/Hydrogen-Wavefunction/
...
if __name__ == "__main__":
    ...
    fig.text(0.0, 1.00,  r'Hydrogen Wave Functions',
            fontsize=28,
    ...
    fig.text(0.0, 0.80,  r'$ \psi_{n\ell m}(r,\theta,\phi) = \sqrt{ \left(\frac{2}{na_0}\right)^3\, \frac{(n-\ell-1)!}{2n[(n+\ell)!]} } e^{-r / na_0} \left(\frac{2r}{na_0}\right)^\ell L_{n-\ell-1}^{2\ell+1}\cdot Y_\ell^m(\theta, \phi)$',
            fontsize='xx-large',
            ha='left', va='top', transform=fig.transFigure, color='w')
    ...
    fig.text(0.00, 0.59,  "    1. The distance between two ticks in the plot is $5\,a_0$.\n    2. The numbers in brackets are the quantum numbers $(n,\,\ell,\,m).$",
            fontsize='small',
            linespacing=1.5,
            ha='left', va='top', transform=fig.transFigure, color='w')

    plt.savefig('hydrogen-wavefunctions.png')
